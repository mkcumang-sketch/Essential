...
import { 
    ...
    TrendingUp, Search, ExternalLink, Truck, Ghost // 🚀 Ghost import add kar diya
} from "lucide-react";
        ...
        <div className="space-y-8 md:space-y-12 animate-in fade-in w-full max-w-[100vw] overflow-x-hidden px-4 sm:px-6 lg:px-8 py-6 md:py-10 bg-[#FAFAFA] min-h-screen text-gray-900">
            ...
            <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-4 md:mb-8 border-b border-gray-200 pb-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto mt-2 sm:mt-0">
                    ...
                    {/* 🚀 NEW: RECOVERY VAULT (ABANDONED CARTS) BUTTON */}
                    <Link 
                        href="/admin/abandoned-carts" 
                        className="flex items-center gap-2 bg-gray-900 text-white px-4 py-3 md:px-5 md:py-4 rounded-xl md:rounded-2xl border border-black shadow-sm hover:bg-[#D4AF37] hover:text-black hover:border-[#D4AF37] transition-all w-full sm:w-auto justify-center group"
                    >
                    ...
                    <div className="flex items-center gap-3 bg-white px-4 py-3 md:px-6 md:py-4 rounded-xl md:rounded-2xl border border-gray-100 shadow-sm w-full sm:w-auto">
            ...
            {/* VIP SEO DASHBOARD SECTION - Mobile Padded */}
            <section className="bg-white border border-gray-200 rounded-3xl md:rounded-[2.5rem] p-6 md:p-12 text-gray-900 shadow-sm relative overflow-hidden group w-full">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                    ...
                    <div className="flex flex-row md:flex-col gap-3 w-full lg:w-auto">
                        <Link href="/admin/seo" className="flex-1 md:flex-none bg-gray-900 text-white px-4 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-[9px] md:text-xs flex items-center justify-center gap-2 hover:bg-black transition-colors whitespace-nowrap">
                            <Search size={14} /> Audit
                        </Link>
                        <Link href="/sitemap.xml" target="_blank" className="flex-1 md:flex-none bg-white border border-gray-200 text-gray-700 px-4 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl font-black uppercase tracking-widest text-[9px] md:text-xs flex items-center justify-center gap-2 hover:border-gray-300 transition-colors whitespace-nowrap">
            ...
            {/* Recent Orders Section - Horizontal scroll for mobile safety */}
            ...
            {/* Client Management Wrapper - Force horizontal scroll if table is big */}
